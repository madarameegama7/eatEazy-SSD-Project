...
export namespace Prisma {
  ...
  */
  ...
  export interface RefreshTokensDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const refreshTokensWithTokenIDOnly = await prisma.refreshTokens.createManyAndReturn({
     *   select: { TokenID: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * const refreshTokensWithTokenIDOnly = await prisma.refreshTokens.updateManyAndReturn({
     *   select: { TokenID: true },
     *   where: {
     *     // ... provide filter here
     *   },
